...
<div style= "margin-left:32%" class="page-title  col-xs-6 col-xs-offset-3">
  ...
  <div class="scrollBar scroll-pane  col-xs-8" id = "scrollbox">
        ...
        <div class="clubs-trans-div" style="width:100%; height:277px;opacity:0"></div>

        <div class="clubs-content">
            <p>“There is no surer foundation for a beautiful friendship than a mutual taste in literature.” ― P.G. Wodehouse
