...
<div class="tab-content scrollBar scroll-pane"  id = "scrollbox" style="width:100%; text-align:left;">
  ...
  <article id="about-els" class="tab-pane fade in active">
              ...
              <p class="clubs_introduction">Art is envisaged to be an integral part of life. The Fine arts club at IIT Kanpur helps its members to develop an aesthetic sense, to let their imagination run wild, and provides them with a platform to showcase their talents, be it in the form of artifacts or performing arts (speed/sand art). It provides an environment for creative minds to learn, expand their horizon, take initiatives, materialize their imagination, and of course, have lots of fun.</p>

  </article>

  <article id="events-els" class="tab-pane fade clubs_events">
              <h3>Some of the major activities conducted by the Fine Arts Club include:</h3>
                <p><b>Summer projects:</b>  oil painting, pencil sketches, clay sculpture</p>
               <p><b>Orientation:</b> sand art performance</p>
                <p><b>Workshops:</b> clay modelling workshop, wall painting workshop</p>
